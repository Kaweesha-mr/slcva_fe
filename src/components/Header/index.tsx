...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-[1000] shadow-md flex w-full border-b border-stroke bg-white dark:border-stroke-dark dark:bg-dark transition-colors duration-500 ease-in-out">
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-[10000] block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-dark-3 dark:bg-dark-2 lg:hidden"
          >
        ...
        <div className="hidden xl:block">
          <div>
            ...
            <p className=" text-gray-6 dark:text-gray-6 font-medium">
