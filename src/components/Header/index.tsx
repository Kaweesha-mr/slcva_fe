...
const Header = (props: {
  ...
  return (
    <header className="bg-inherit sticky top-0 z-999 shadow-md flex w-full border-b border-stroke bg-white dark:border-stroke-dark dark:bg-dark transition-colors duration-500 ease-in-out">
